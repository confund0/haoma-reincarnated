...
// Mechanical edit vs upstream: missinggo.IsEmptyValue inlined as
// isEmptyValue below to drop the missinggo transitive (same logic,
// imported verbatim from missinggo/empty_value.go).
